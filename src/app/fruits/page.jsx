...
export default function FruitsPage() {
  ...
  const { data: products = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return allProducts.filter((product) => product.category === "fruits");
    },
  });
    ...
    <div className="min-h-screen bg-gray-900 font-inter">
      ...
      <section className="relative py-24 overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1610832958506-aa56368176cf?w=1920&h=600&fit=crop"
            alt="Fresh fruits"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-2xl md:text-3xl text-gray-200 font-bold max-w-3xl mx-auto">
            Sweet, juicy, and vitamin-packed seasonal favorites straight from
            our orchards
          </p>
        </div>
      </section>
