...
export default function LivestockPage() {
  ...
  const { data: products = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return allProducts.filter((product) => product.category === "livestock");
    },
  });
  ...
  const getProductImage = (product) => {
    const imageMap = {
      ...
      Cow: "https://images.unsplash.com/photo-1516467508483-a7212febe31a?w=600&h=400&fit=crop",
      Eggs: "https://images.unsplash.com/photo-1582722872445-44dc5f7e3c8f?w=600&h=400&fit=crop",
    };
    return (
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-2xl md:text-3xl text-gray-200 font-bold max-w-3xl mx-auto">
            Ethically raised animals and farm-fresh dairy products
          </p>
        </div>
      </section>
